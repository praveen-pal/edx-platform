...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Praveen'
        db.create_table('student_praveen', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('classroom_topic', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('course_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('student', ['Praveen'])


    def backwards(self, orm):
        # Deleting model 'Praveen'
        db.delete_table('student_praveen')
