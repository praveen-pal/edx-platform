...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Praveen.course_name'
        db.add_column('student_praveen', 'course_name',
                      self.gf('django.db.models.fields.CharField')(default='nothing', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Praveen.course_name'
        db.delete_column('student_praveen', 'course_name')
