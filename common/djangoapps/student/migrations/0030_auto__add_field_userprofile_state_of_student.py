...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.state_of_student'
        db.add_column('auth_userprofile', 'state_of_student',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.state_of_student'
        db.delete_column('auth_userprofile', 'state_of_student')
    ...
    models = {
        ...
        'student.praveen': {
            'Meta': {'object_name': 'Praveen'},
            'classroom_topic': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        'student.userprofile': {
            ...
            'state_of_student': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '10', 'null': 'True', 'blank': 'True'}),
